...
namespace egl {
  ...
  public:
    ...
    /**
     * @brief Bind an already-converted texture directly as the loaded frame (RKMPP zero-copy path).
     *
     * @param texture Texture resource that already holds the encoder-ready frame.
     */
