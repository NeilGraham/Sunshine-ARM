...
if (NPM_OFFLINE)
    set(NPM_INSTALL_FLAGS "${NPM_INSTALL_FLAGS}" "--offline" "--include=optional" "--no-package-lock")
else()
    set(NPM_INSTALL_FLAGS "${NPM_INSTALL_FLAGS}" "--include=optional" "--no-package-lock")
endif()
